...
int main(int argc, char ** argv)
{
	...
	std::cout << "C:" << std::endl;
	C.Print();
	std::cout << "C(0.125): " << (25*ceil(4*0.125)) << std::endl;
	C = C0 + C1*(25*ceil(4*0.125));
	C.Print();
	std::cout << "C(0.375): " << (25*ceil(4*0.375)) << std::endl;
	C = C0 + C1*(25*ceil(4*0.375));
	C.Print();
	std::cout << "C(0.625): " << (25*ceil(4*0.625)) << std::endl;
	C = C0 + C1*(25*ceil(4*0.625));
	C.Print();
	std::cout << "C(0.875): " << (25*ceil(4*0.875)) << std::endl;
	C = C0 + C1*(25*ceil(4*0.875));
	C.Print();
